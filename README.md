...
## Задача 2. Информация по оттоку водителей компании Uber  - [ссылка на SQL](https://github.com/PavelRawel/sql_test/blob/main/sql/task_2)
...
## Задача 3. Медианная цена вин - [ссылка на SQL](https://github.com/PavelRawel/sql_test/blob/main/sql/task_3)
...
## Задача 4. Количество активных клиентов - [ссылка на SQL](https://github.com/PavelRawel/sql_test/blob/main/sql/task_4)
